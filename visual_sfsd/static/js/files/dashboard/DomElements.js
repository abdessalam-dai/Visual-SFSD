export const createFileBtn = document.querySelector("#create-file-btn");
export const createFileModalOverlay = document.querySelector("#create-file-modal-overlay");
export const createFileModal = document.querySelector("#create-file-modal");

export const step1 = document.querySelector("#step-1");
export const step2 = document.querySelector("#step-2");
export const step3Sequential = document.querySelector("#step-3-sequential");
export const step3Indexed = document.querySelector("#step-3-indexed");
export const step3Hashing = document.querySelector("#step-3-hashing");

export const step4 = document.querySelector("#step-4");
...
export const fileTypeBtns = document.querySelectorAll("#file-type-btn");